...
- Limited: Chinese/Japanese/Korean target PDF output with the default LaTeX templates. The current templates use `pdflatex` with UTF-8 input and T1 font encoding, but do not include a CJK-capable template, font setup, or XeLaTeX/LuaLaTeX workflow.
